...
ifneq (,$(BOARD_ADDITIONAL_KERNEL_MAKE_ENV))
TARGET_KERNEL_MAKE_ENV += $(BOARD_ADDITIONAL_KERNEL_MAKE_ENV)
endif
...
$(TARGET_PREBUILT_KERNEL): $(KERNEL_OUT) $(DTC) $(KERNEL_USR) $(BOARD_ADDITIONAL_KERNEL_DEPENDENCIES)
...
$(GKI_TARGET_PREBUILT_KERNEL): $(DTC) $(UFDT_APPLY_OVERLAY) $(GKI_KERNEL_OUT) $(BOARD_ADDITIONAL_KERNEL_DEPENDENCIES)
