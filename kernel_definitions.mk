...
TARGET_KERNEL_MAKE_ENV += DEPMOD=$(HOST_OUT_EXECUTABLES)/depmod
...
ifeq ($(KERNEL_LLVM_SUPPORT),true)
  ...
  cc := CC=$(KERNEL_LLVM_BIN)/clang CLANG_TRIPLE=aarch64-linux-gnu- AR=$(KERNEL_LLVM_BIN)/llvm-ar LLVM_NM=$(KERNEL_LLVM_BIN)/llvm-nm LD=$(KERNEL_LLVM_BIN)/ld.lld NM=$(KERNEL_LLVM_BIN)/llvm-nm
