...
KERNEL_CROSS_COMPILE_COMPAT := arm-linux-gnueabi-
...
ifeq ($(KERNEL_LLVM_SUPPORT),true)
  ...
  cc := CC=clang
  real_cc := PATH=$(KERNEL_LLVM_BIN):$$PATH REAL_CC=clang CLANG_TRIPLE=aarch64-linux-gnu- AR=llvm-ar LLVM_NM=llvm-nm OBJCOPY=llvm-objcopy LD=ld.lld NM=llvm-nm LLVM=1 LLVM_IAS=1
else
