...
ifeq ($(GKI_KERNEL),1)
  ifeq "$(KERNEL_DEFCONFIG)" "vendor/$(GKI_PLATFORM_NAME)-qgki_defconfig"
    ...
    GKI_KERNEL_DEFCONFIG := vendor/$(GKI_PLATFORM_NAME)-gki_defconfig
...
ifeq "$(KERNEL_DEFCONFIG)" "vendor/$(GKI_PLATFORM_NAME)-gki_defconfig"
...
define build-kernel
	...
	TARGET_PRODUCT=$(GKI_PLATFORM_NAME) \
